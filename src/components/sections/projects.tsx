  ...
  return (
    <section id="projects" className="py-24 scroll-m-20 relative">
      <div className="max-w-7xl mx-auto px-6">
        ...
        {/* Personal Projects */}
        <ProjectsSection projects={projects.personal || []} name="Personal Projects" />

        {/* Client Projects */}
        {portfolioConfig.dynamicSections.showclientprojects && projects?.client && (<ProjectsSection projects={projects?.client || []} name="Client Projects" />)}
      </div>
    </section>
  );
}
...
function ProjectsSection({ projects,name }: { projects: Project[]; name: string }) {
    return (
        <div className="mb-24">
          <h3 className="text-3xl font-semibold mb-12 text-center text-primary/80">{name}</h3>
